...
ForestTry$coefs #Null
ForestTry$importance # gives importance of each variable
ForestTry$terms
ForestTry$type # regression

plot(ForestTry) # graph on error as it reduces and becomes constant
...
# The Random Forest has region holding more importance than distance, opposite the linear regression models
# For the above plot you can set just the top variables by using n.var = 10 or 5 or hoever many you want showing
...
# Call:
#   randomForest(formula = Price ~ ., data = mxTrain, method = "anova") 
# Type of random forest: regression
# Number of trees: 500
# No. of variables tried at each split: 3

# Mean of squared residuals: 0.007478869
# % Var explained: 83.55

#------
# if done with method 'anova'
# Mean of squared residuals: 0.007496329
# % Var explained: 83.52
#-----
...
# below compare the predictions to the price in training data - price is in log10
head(PreTry)        # 6.026135 6.256668 6.154969 6.130439 5.951412 6.070043
head(mxTrain$Price) # 6.014940 6.273233 6.213783 6.117271 5.949390 6.118926

PreTest <- predict(ForestTry, mxTest) # would like close gap on RMSE between train and test
(RMSE(PreTest, mxTest$Price))
# 0.08967545

#----------

# attempting to tune the Random Forest
...
# mtry = 3  OOB error = 0.0005702294 

#-------

# messing around to fine tune
# varify what anova is doing here 
# anova to predict continuous variable
...
# Call:
#  randomForest(formula = Price ~ ., data = mxTrain, method = "anova",      ntree = 500, importance = T) 
# Type of random forest: regression
# Number of trees: 500
# No. of variables tried at each split: 3

# Mean of squared residuals: 0.007484606
# % Var explained: 83.54
